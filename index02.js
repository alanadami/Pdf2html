...
app.post("/upload", upload.single('pdf'), (req, res) => {
    ...
    // Caminho para o Poppler (usando variável de ambiente ou caminho padrão)
    //const popplerPath = process.env.POPPLER_PATH || "C:\\poppler\\poppler-24.08.0\\Library\\bin\\pdftohtml.exe";
    const popplerPath = process.env.POPPLER_PATH || "C:\\poppler\\poppler02\\Library\\bin\\pdftohtml.exe";
    //const popplerPath = path.join(__dirname, "poppler", "poppler-24.08.0", "Library", "bin", "pdftohtml.exe");

    // //---------------------------------------------------------------
    // // Define o caminho do Poppler corretamente dentro do `pkg`
    ...
    //     console.error("Erro: Poppler não encontrado:", popplerPath);
    //     process.exit(1);
    // }

    // console.log("Usando Poppler:", popplerPath);
